...
DrumInstrument instrument[INSTRUMENTS_COUNT] = {
    {wav_perc_kick, wav_perc_kick_length, 0, false},
    {wav_perc_shaker, wav_perc_shaker_length, 0, false},
    {wav_perc_snare, wav_perc_snare_length, 0, false},
    {wav_perc_stick, wav_perc_stick_length, 0, false}
};